...
const showTimerock = document.querySelector("#showtimebtn1")
...
function showHappyrock(){

if (hasHair) 
        if(huidigeFoto.src.endsWith("haar1-rock.png")){
        huidigeFoto.src ="images/haar1.1-rock.png"
        }
        else if (huidigeFoto.src.endsWith("haar2-rock.png")){
        huidigeFoto.src ="images/haar2.1-rock.png" }
        else if (huidigeFoto.src.endsWith("haar3-rock.png")){
            huidigeFoto.src ="images/haar3.1-rock.png" }
    
        else {
        huidigeFoto.src ="images/haar4.1-rock.png"
        }
...
showTimerock.addEventListener("click",showHappyrock)
