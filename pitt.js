...
const showTimepitt = document.querySelector("#showtimebtn2")
...
// bron voor endswith: youtube tutorial voor image slider: https://youtu.be/749ta0nvj8s?si=7MUBc705D6AdI7pY
...
function showHappypitt(){

    if (hasHair) 
            if(huidigeFoto.src.endsWith("haar1-pitt.png")){
            huidigeFoto.src ="images/haar1.1-pitt.png"
            }
            else if (huidigeFoto.src.endsWith("haar2-pitt.png")){
            huidigeFoto.src ="images/haar2.1-pitt.png" }
            else if (huidigeFoto.src.endsWith("haar3-pitt.png")){
                huidigeFoto.src ="images/haar3.1-pitt.png" }
        
            else {
            huidigeFoto.src ="images/haar4.1-pitt.png"
            }
...
showTimepitt.addEventListener("click",showHappypitt)
